 ...
 */
class VerifyAdminTokenMiddleware implements MiddlewareInterface
{
    /**
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        try {
            $response = $this->client->request('GET', config('oauth_url') . '/get.admin.info', [
                'headers' => [
        ...
        Context::set('admin_id',(int) $data['data']['user_info']['id']);
